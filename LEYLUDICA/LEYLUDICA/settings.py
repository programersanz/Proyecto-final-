"""
Django settings for LEYLUDICA project.
...
SECRET_KEY = 'django-insecure-ewq4k4-j&yi%(z(4l=5t=j&k)4*6jqdonm&#)1vv)u995s7q*9'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'LEYLUDICA', 'horas', 'static')]
